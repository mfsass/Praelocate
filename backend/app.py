...
def calculate_midpoint(list_json):
    ...
    for j in range(0, 5):
        ...
        try:
            ...
            average_distance_time_array.append({location_string: [average_distance, average_time, all_distance, all_time, average_time_weighted, origin_tuple]})
            all_distance.clear()
            all_time.clear()
    ...
    optimised_location = average_distance_time_array["location_from_mid0"]
    for k in range(1, 5):
        key_string = "location_from_mid" + str(k)
        if average_distance_time_array[key_string][1] < min:
            min = average_distance_time_array[key_string][1]
            optimised_location = average_distance_time_array[key_string]
